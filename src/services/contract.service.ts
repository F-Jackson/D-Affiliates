...
export class ContractService {
  ...
  private buildHeader(
    ...
    pdf.fontSize(18).font('Helvetica-Bold').text(
      'AFFILIATE OVERVIEW & FINANCIAL SUMMARY',
      { align: 'center' },
    );
    ...
    pdf.fontSize(9).font('Helvetica').text(
      `Reference ID: ${contract.contractId} | Version: ${version}`,
      { align: 'center' },
    );
...
Any modification invalidates the digital signature and integrity hashes.`,
  ...
  private buildInvisibleWatermark(
    ...
    pdf.opacity(0.01);
    pdf.fontSize(50).rotate(-45, { origin: [300, 400] }).text(
  ...
  private buildIntegritySection(
    ...
    pdf.fontSize(10).font('Helvetica-Bold').text(
